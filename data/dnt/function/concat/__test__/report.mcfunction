...
tellraw @a [{"nbt":"state.case.name","storage":"dnt:zconcat_test"},{"text":"§b|§r char: "},{"score":{"name":"#char_time","objective":"dnt.concat.test"},color:"yellow"},{"text":" §b|§r nbt: "},{"score":{"name":"#nbt_time","objective":"dnt.concat.test"},color:"yellow"},{"text":" §b|§r auto: "},{"score":{"name":"#concat_time","objective":"dnt.concat.test"},color:"yellow"}]
...
schedule function dnt:concat/__test__/next 1t replace
